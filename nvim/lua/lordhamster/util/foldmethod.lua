...
function M.fold_markdown_headings_2()
...
function M.fold_markdown_headings_3()
  -- "Update" saves only if the buffer has been modified since the last save
  vim.cmd("silent update")
  -- Unfold everything first or I had issues
  vim.cmd("normal! zx")
...
function M.fold_markdown_headings_4()
  -- "Update" saves only if the buffer has been modified since the last save
  vim.cmd("silent update")
  -- Unfold everything first or I had issues
  vim.cmd("normal! zx")
...
function M.fold_markdown_headings_5()
  -- "Update" saves only if the buffer has been modified since the last save
  vim.cmd("silent update")
  -- Unfold everything first or I had issues
  vim.cmd("normal! zx")
...
function M.fold_markdown_headings_6()
  -- "Update" saves only if the buffer has been modified since the last save
  vim.cmd("silent update")
  -- Unfold everything first or I had issues
  vim.cmd("normal! zx")
  fold_markdown_headings({ 6 })
  vim.cmd("normal! zz") -- center the cursor line on screen
end
return M
