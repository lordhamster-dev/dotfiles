...
2. **Install Packages**
   ...
   ```bash
   sudo pacman -S hyprpaper hypridle hyprlock hyprpicker hyprland-qtutils waybar jq blueberry brightnessctl pavucontrol xorg xorg-xwayland xdg-desktop-portal-hyprland xdg-desktop-portal-gtk polkit-kde-agent qt5-wayland qt6-wayland qt5ct qt6ct nwg-look udiskie pipewire-pulse
   ```
